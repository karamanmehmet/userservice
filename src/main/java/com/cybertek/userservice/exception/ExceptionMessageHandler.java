...
import com.cybertek.userservice.dto.DefaultExceptionMessageDto;
...
public class ExceptionMessageHandler {
    ...
    private Optional<DefaultExceptionMessageDto> getMessageFromAnnotation(Method method) {
        com.cybertek.userservice.annotation.DefaultExceptionMessage defaultExceptionMessage = method.getAnnotation(com.cybertek.userservice.annotation.DefaultExceptionMessage.class);
